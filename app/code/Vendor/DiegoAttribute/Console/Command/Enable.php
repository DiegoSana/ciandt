...
{
    public const COMMAND_NAME = 'diegoattribute:settings:enable';
    ...
    protected function configure(): void
    {
        ...
        $this->setDescription("Enable diego attribute status");
        $this->setDefinition([
    ...
    protected function execute(
        ...
        try {
            ...
            $this->attributeManagement->setStatus(true, (int) $store);
            $output->writeln("Diego attribute value was enabled.");
